...
reserved_non_modifiers:
	...
	| T_FUNCTION | T_CONST | T_RETURN | T_DEFER | T_PRINT | T_YIELD | T_LIST | T_SWITCH | T_ENDSWITCH | T_CASE | T_DEFAULT
...
statement:
	...
	|	T_DEFER optional_expr ';'		{ $$ = zend_ast_create(ZEND_AST_DEFER, $2); }
